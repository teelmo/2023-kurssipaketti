  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/font/', to: '../public/assets/font/', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
        ...
        { from: 'assets/data/2023-kurssipaketti - erokurssi.csv', to: '../public/assets/data/2023-kurssipaketti_erokurssi.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
        { from: 'assets/data/2023-kurssipaketti - sijoituskurssi.csv', to: '../public/assets/data/2023-kurssipaketti_sijoituskurssi.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},

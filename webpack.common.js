  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: 'assets/data/2023-kurssipaketti - example.csv', to: '../public/assets/data/2023-kurssipaketti_example.csv', noErrorOnMissing: true, globOptions: { dot: true, gitignore: true, ignore: ['**/.DS_Store'] }},
